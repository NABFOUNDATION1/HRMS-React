...
import ManageInternBox from "../../components/manageInternBox";
const ManageIntern = () =>
{
    ...
    return(
        ...
        ></div>
            ...
            <div className="flex-grow-1">
                <Header showSearchBar={true} searchType="intern" showButton={true} toggleSidebar={() => setIsSideBarOpen(!isSideBarOpen)} />
